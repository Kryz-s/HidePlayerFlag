package net.kryz.hideflag.events;
...
public class PlayerExitInRegionEvent extends Event implements Cancellable {
     ...
     */
    public PlayerExitInRegionEvent(UUID playerUUID, @NotNull ProtectedRegion region) {
